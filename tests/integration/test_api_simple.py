...
class TestInventoryAPIIntegration:
    ...
    def test_warehouse_crud_workflow(self):
        ...
        response = requests.put(f"{BASE_URL}/api/inventory/warehouses/{warehouse_id}", json=update_data)
        assert response.status_code == 200
    ...
    def test_item_crud_workflow(self):
        ...
        response = requests.put(f"{BASE_URL}/api/inventory/items/{item_id}", json=update_data)
        assert response.status_code == 200
    ...
    def test_inventory_level_workflow(self):
        ...
        warehouse_response = requests.post(f"{BASE_URL}/api/inventory/warehouses", json=warehouse_data)
        ...
        print(f"✅ Created inventory level")
        ...
        response = requests.post(f"{BASE_URL}/api/inventory/reserve", params=reserve_params)
        assert response.status_code == 200
        print(f"✅ Reserved 10 units")
        
        # Check inventory level after reservation
        response = requests.get(f"{BASE_URL}/api/inventory/inventory/{item_id}/{warehouse_id}")
        assert response.status_code == 200
        ...
        print(f"✅ Inventory after reservation: 50 current, 10 reserved, 40 available")
        ...
        response = requests.post(f"{BASE_URL}/api/inventory/release", params=release_params)
        assert response.status_code == 200
        print(f"✅ Released 5 units from reservation")
        ...
        print(f"✅ Final inventory: 30 current, 5 reserved, 25 available")
    ...
    def test_error_handling(self):
        ...
        print(f"✅ 404 error handling works for items")
        
        response = requests.get(f"{BASE_URL}/api/inventory/warehouses/{non_existent_id}")
        assert response.status_code == 404
        print(f"✅ 404 error handling works for warehouses")
        
        response = requests.get(f"{BASE_URL}/api/inventory/inventory/{non_existent_id}/{non_existent_id}")
        assert response.status_code == 404
        print(f"✅ 404 error handling works for inventory levels")
