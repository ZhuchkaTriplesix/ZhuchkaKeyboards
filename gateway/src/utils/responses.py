...
def api_responses(
    ...
    *extra_responses: Dict[int, Union[Dict[str, Any], Type[BaseModel]]],
    ...
    responses = {
        ...
        status.HTTP_404_NOT_FOUND: {"description": "Not Found", "model": NotFoundError},
    ...
    if success_model:
        responses[200] = {"description": "Successful Response", "model": success_model}
